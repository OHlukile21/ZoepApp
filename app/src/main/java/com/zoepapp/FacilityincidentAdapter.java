...
public class FacilityincidentAdapter extends RecyclerView.Adapter<FacilityincidentAdapter.ViewHolder> {
    private List<ModelFacilityIncident> items;
    private int selectedItem = -1;
    Context context;
    private OnIncidentLongClickListener listener;
    public FacilityincidentAdapter(Context context, List<ModelFacilityIncident> items, OnIncidentLongClickListener listener) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ModelFacilityIncident item = items.get(position);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ModelFacilityIncident incident, OnIncidentLongClickListener listener) {
